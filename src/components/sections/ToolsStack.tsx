...
// 4-column × 3-row grid — scatter empty slots for visual rhythm
const grid: (Tool | null)[] = [
  tools[0], tools[1], tools[2], null,
  null,     tools[3], tools[4], tools[5],
  tools[6], tools[7], tools[8], tools[9],
];
      ...
      <Container>
        <div className="grid gap-16 md:grid-cols-2 md:items-center">
          ...
          <FadeIn direction="right" delay={0.1}>
            {/* CSS mask fades the right edge — no overflow-hidden so hover zoom is never clipped */}
            <div
              className="relative"
              style={{
